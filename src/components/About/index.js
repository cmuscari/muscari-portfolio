            ...
            <div className="section-1">
                <div className="section-1-text">
                    ...
                    <p className="section-1-text-content">
                        ...
                        I have a passion for creating beautiful + functional web applications that are intuitive, efficient, accessible, responsive + well-performing.
                        <br></br>
                        <br></br>
                        I'm looking to join a team that will encourage me to build upon my skills by developing web applications that stand out from the crowd.
                    </p>
                </div>
                <div>
            ...
            <div className="section-2">
                ...
                <div className="section-2-text">
                    ...
                    <p className="section-2-text-content">
                        ...
                        <br></br>
                        <br></br>
                        Having a design background made for a smooth transition into Web Development.  Both are extremely technical, detail-oriented fields that require me to think creatively to come up with unique, out-of-the-box solutions to problems.  I'm excited to continue my journey in the development world.
                    </p>
                </div>
            </div>
